...
const About: FC = () => {
    ...
    return <div className={classes.root}>
        ...
        <div className={classes.paragraph}>
            <span>{aboutCompany.paragraph4.substring(0, 11)}</span><b>{aboutCompany.paragraph4.substring(11, 25)}</b>{aboutCompany.paragraph1.substring(25, aboutCompany.paragraph1.length)}
        </div>
        <div className={classes.paragraph}>
